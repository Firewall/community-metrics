...
<body>
  <div class="container">
    ...
    <div class="stats-grid">
      <div class="stat-card">
        <div class="stat-value">${snapshots[snapshots.length - 1].metrics.pullRequests.open}</div>
        <div class="stat-label">Open PRs</div>
      </div>
      <div class="stat-card">
        <div class="stat-value">${snapshots[snapshots.length - 1].metrics.issues.open}</div>
        <div class="stat-label">Open Issues</div>
      </div>
      <div class="stat-card">
        <div class="stat-value">${snapshots[snapshots.length - 1].metrics.pullRequests.mergeRate}%</div>
        <div class="stat-label">PR Merge Rate</div>
      </div>
      <div class="stat-card">
        <div class="stat-value">${snapshots[snapshots.length - 1].metrics.issues.closeRate}%</div>
  ...
  <script>
    ...
    new Chart(document.getElementById('discussionsChart'), {
      type: 'line',
      data: {
        labels: ${JSON.stringify(dates)},
        datasets: [
